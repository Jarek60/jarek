...
def counting_vowels_and_consonants(input_string):
    vowels = "aeiouAEIOU"
    num_vowels = 0
    num_consonants = 0
...
print(f"The paragraph has {average_vowels_and_consonants(paragraph)[0]} sentences. It has an average of {average_vowels_and_consonants(paragraph)[1]:.2f} vowels per sentence and an average of {average_vowels_and_consonants(paragraph)[2]:.2f} consonants per sentence.")